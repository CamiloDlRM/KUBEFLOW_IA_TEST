...
import { Eye, EyeOff, Github, Mail, Lock, Loader2, CheckCircle2, Check } from 'lucide-react';
            ...
            >
              ...
              <div className="backdrop-blur-xl bg-[#18181b]/60 border border-[#27272a] rounded-2xl p-8">
                ...
                <form onSubmit={handleSubmit} className="mt-6 space-y-4">
                  ...
                  >
                    <label
                      className="flex cursor-pointer items-center gap-2 text-sm text-[#a1a1aa]"
                      onClick={() => setRemember(!remember)}
                    >
                      <div className={`flex h-4 w-4 shrink-0 items-center justify-center rounded border transition-colors ${remember ? 'border-[#a1a1aa] bg-transparent' : 'border-[#3f3f46] bg-transparent'}`}>
