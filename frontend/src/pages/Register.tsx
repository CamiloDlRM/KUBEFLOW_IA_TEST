...
import { Eye, EyeOff, Github, Mail, Lock, User, Loader2, CheckCircle2, Check } from 'lucide-react';
  ...
  return (
    <div className="relative min-h-screen bg-[#09090b] font-['Inter',sans-serif] overflow-hidden">
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center">
        <div className="flex w-full max-w-6xl mx-auto items-center gap-12 lg:gap-16 px-6">
                  ...
                  {isSuccess ? (
                    ...
                    >
                      ...
                      <form onSubmit={handleSubmit} className="mt-6 space-y-4">
                        ...
                        >
                          <label
                            className="flex cursor-pointer items-start gap-2 text-sm text-[#a1a1aa]"
                            onClick={() => setAcceptTerms(!acceptTerms)}
                          >
                            <div className={`mt-0.5 flex h-4 w-4 shrink-0 items-center justify-center rounded border transition-colors ${acceptTerms ? 'border-[#a1a1aa] bg-transparent' : 'border-[#3f3f46] bg-transparent'}`}>
                        ...
                        >
                          <button
                            ...
                            className="w-full rounded-xl border border-[#27272a] bg-[#27272a]/30 py-3 font-semibold text-white transition-colors hover:bg-[#27272a]/70 backdrop-blur-sm disabled:opacity-50 flex items-center justify-center gap-2"
                          >
                            {isLoading ? (
                              <>
